<template>
  <div>
    <div class="q-pb-md">
      <q-btn @click="selectNetwork = !selectNetwork" flat style="background-color: #55bc8a; color: white" padding="sm md" dense><div>已选择<span style="color: #3A6FD5"> {{ inputOptionsForm.options.default.length }} </span>台数通设备</div></q-btn>
    </div>
